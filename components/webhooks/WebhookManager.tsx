    ...
    <div className="space-y-8 px-6 py-8 lg:px-10">
      <section>
        <div className="flex flex-wrap items-center justify-between gap-3">
          <div>
            <h2 className="text-[15px] font-semibold text-ink">Endpoints</h2>
          ...
          <button
            ...
            className="inline-flex h-9 items-center gap-2 rounded-full bg-accent px-4 text-[13px] font-medium text-white hover:bg-accent-soft"
          >
        ...
        {creating && (
          <div className="mt-4 max-w-[640px] space-y-3.5 rounded-2xl border border-hairline bg-surface p-5">
            <label className="block">
              <span className="text-[12px] text-ink-muted">Endpoint URL</span>
              <input
                value={url}
            ...
            <label className="block">
              <span className="text-[12px] text-ink-muted">Label (optional)</span>
              <input
                value={description}
            ...
            <div>
              ...
              <div className="grid gap-1.5 sm:grid-cols-2">
                {WEBHOOK_EVENTS.map((event) => (
                  <label
                    key={event}
                    className="flex cursor-pointer items-center gap-2 rounded-lg px-2 py-1.5 text-[12.5px] text-ink-muted hover:bg-surface-2"
                  >
                    <input
                      type="checkbox"
                    ...
                    <code className="text-[10.5px] text-ink-faint">{event}</code>
                  </label>
                ))}
              </div>
            </div>
              ...
              {endpoints.map((endpoint) => (
                ...
                >
                  <div className="flex flex-wrap items-start justify-between gap-3">
                    ...
                    <div className="flex shrink-0 items-center gap-1.5">
                      <button
                        ...
                        className="inline-flex h-8 items-center gap-1.5 rounded-lg border border-hairline px-2.5 text-[12px] text-ink-muted transition-colors hover:text-ink disabled:opacity-40"
                      >
                        {testing === endpoint.id ? (
                      ...
                      <button
                        ...
                        className="grid h-8 w-8 place-items-center rounded-lg border border-hairline text-ink-muted transition-colors hover:border-[#FF5A5A]/50 hover:text-[#FF5A5A]"
                      >
                  ...
                  <div className="mt-3 flex items-center gap-2 border-t border-hairline pt-3">
                    ...
                    <code className="truncate font-mono text-[11px] text-cyan">
                    ...
                    <button
                      ...
                      className="ml-auto inline-flex items-center gap-1 text-[11.5px] text-ink-muted hover:text-ink"
                    >
      ...
      <section>
        <h2 className="text-[15px] font-semibold text-ink">Recent deliveries</h2>
