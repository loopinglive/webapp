...
export function PersonaCard({
  ...
  return (
    <button
      onClick={onClick}
      className="group flex w-full items-center gap-3.5 rounded-xl border border-hairline bg-surface p-4 text-left transition-colors duration-200 hover:border-accent/40"
    >
      ...
      <div className="min-w-0 flex-1">
        ...
        <p className="mt-0.5 flex items-center gap-3 text-[11.5px] text-ink-muted">
          {persona.location && (
