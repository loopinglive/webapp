...
export function WebinarSidebar({
  ...
  const items: Item[] = [
    ...
    { href: `${base}/experiments`, label: "Split Tests", icon: FlaskConical },
    ...
    { href: `${base}/co-hosts`, label: "Co-hosts", icon: UserPlus },
    { href: `${base}/automation`, label: "Automation", icon: Send },
    { href: `${base}/agents`, label: "Follow-up Agents", icon: Bot },
    { href: `${base}/nurture`, label: "Predictive Nurture", icon: Clock },
    { href: `${base}/preview`, label: "Preview", icon: Eye },
    { href: `${base}/live`, label: "Go Live", icon: Radio },
    { href: `${base}/streaming`, label: "Multi-Platform Streaming", icon: Rss },
    ...
    { href: `${base}/captions`, label: "Video Captions", icon: Captions },
    { href: `${base}/video-features`, label: "Video Chapters", icon: Clapperboard },
    { href: `${base}/gdpr-requests`, label: "GDPR Requests", icon: ShieldCheck },
