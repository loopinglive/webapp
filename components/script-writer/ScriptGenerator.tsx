    ...
    <div className="mx-auto max-w-xl px-6 py-8 lg:px-10">
      ...
      <div className="mt-6 space-y-4">
        <label className="block">
          <span className="text-[12px] text-ink-muted">Topic</span>
          <input
            value={topic}
        ...
        <label className="block">
          <span className="text-[12px] text-ink-muted">Target audience (optional)</span>
          <input
            value={audience}
        ...
        <div className="grid gap-3 sm:grid-cols-2">
          <label className="block">
            <span className="text-[12px] text-ink-muted">Offer (optional)</span>
            <input
              value={offer}
          ...
          <label className="block">
            <span className="text-[12px] text-ink-muted">Price (optional)</span>
            <input
              value={price}
        ...
        <div>
          <span className="text-[12px] text-ink-muted">Tone</span>
        ...
        <div>
          <span className="text-[12px] text-ink-muted">Length</span>
