      ...
      <section className="rounded-2xl border border-[#22C55E]/40 bg-[#22C55E]/[0.06] p-5">
        ...
        <div className="mt-3 flex gap-2">
          ...
          <button
            ...
            className="h-9 rounded-lg bg-hairline px-3 text-[12.5px] text-ink hover:bg-surface-3"
          >
            I have saved them
          </button>
        </div>
      ...
      {status.enabled ? (
          ...
          <div className="mt-3 flex flex-wrap items-start gap-4">
            ...
            <div className="min-w-0 flex-1">
              ...
              <input
                ...
                className="mt-3 h-10 w-full rounded-lg border border-hairline bg-void px-3 font-mono text-[16px] tracking-[0.3em] text-ink placeholder:text-ink-faint focus:border-accent focus:outline-none"
              />
              ...
              <div className="mt-2 flex gap-2">
                <button
                  ...
                  className="inline-flex h-9 items-center gap-2 rounded-lg bg-accent px-3.5 text-[12.5px] font-medium text-white hover:bg-accent-deep disabled:opacity-50"
                >
                  {busy && <Loader2 className="h-3.5 w-3.5 animate-spin" />}
                  Turn it on
                </button>
        ...
        <>
          ...
          <button
            onClick={() => void begin()}
            disabled={busy}
            className="mt-3 inline-flex h-9 items-center gap-2 rounded-lg bg-accent px-3.5 text-[12.5px] font-medium text-white hover:bg-accent-deep disabled:opacity-60"
          >
            {busy && <Loader2 className="h-3.5 w-3.5 animate-spin" />}
            Set it up
          </button>
